...
const Home = () => (
  <>
    ...
    <div className="card-container">
      <div className="card red" style={{backgroundColor: 'black'}}>
        ...
        <div className="card-content">
          ...
          <Link to="/concepts">SEE MORE</Link>
        </div>
      </div>
      <div className="card green"style={{backgroundColor: 'black'}}>
        <img src="/files/tools1.jpg" alt="ML Image" />
        <div className="card-content">
          <h3>AI Tools</h3>
          <p>Explore powerful AI tools like ChatGPT, Midjourney, Runway ML, and more that are transforming the way we create, work, and solve problems with automation and intelligence.</p><br/>
          <Link to="/tools">SEE MORE</Link>
        </div>
      </div>
      <div className="card blue"style={{backgroundColor: 'black'}}>
        <img src="/files/career.jpg" alt="DL Image" />
        <div className="card-content">
          <h3>AI Career Paths</h3>
          <p>Navigate through top AI career roles such as Data Scientist, AI Engineer, and ML Researcher. Discover the skills, roadmaps, and resources needed to kickstart a career in AI.</p><br/>
          <Link to="/career">SEE MORE</Link>
        </div>
      </div>
      <div className="card purple"style={{backgroundColor: 'black'}}>
        <img src="/files/news.jpg" alt="LLM Image" />
        <div className="card-content">
          <h3>AI News</h3>
          <p>Stay updated with the latest breakthroughs, innovations, and real-world applications of AI. Follow industry trends, global policies, and ethical developments shaping the future.</p><br/>
